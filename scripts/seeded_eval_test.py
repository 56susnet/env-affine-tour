...
LORA_MODEL_NAME = "gradients-io-tournaments/goofspiel_8x_h100_mcts_opponent_thinking_4hr"
...
if __name__ == "__main__":
    ...
    for _ in range(100):
        random_selected_seed = random.randint(42, 10000)
        print(f"Testing Eval with Seed: {random_selected_seed}...")
        score = run_evaluation(random_selected_seed)
        scores.append((random_selected_seed, score))

    for evaluation in scores:
        print(f"Seed: {evaluation[0]}, Score: {evaluation[1]}")
